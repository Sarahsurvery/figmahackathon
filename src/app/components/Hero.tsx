    ...
    <section className="{`${font.className} links-parent`} bg-grey-100 py-12">
      <div className="container mx-auto flex flex-col md:flex-row items-center md:items-start">
        ...
        <div className="w-full md:w-2/3 py-[12%] text-center md:text-left">
          ...
          <Image src="/Sofaheader.png" alt="Sofa" className="w-2/3 md:w-full relative bottom-40" />
          </div>
        </div>
       </div>
       ...
       <div className="w-full md:w-2/3 text-2xl flex flex-col ml-[30%] px-[5%] top-[90%] absolute justify-center">
          ...
          <div  className="w-full md:w-1/2 ml-[-50%] pl-20 mt-[-20%]">
            <Image src="/chair1.png" alt="Chair" className="w-1/2 md:w-full relative mt-[50%] px-10" />
          ...
          <Image src="/GreenRec.png" alt="rectangle" className=" shadow-green-600"/>
          <Image src="/RedRec.png" alt="rectangle" className=" shadow-red-600"/>
          <Image src="/BlueRec.png" alt="rectangle" className=" shadow-blue-600"/>
          </div>
          ...
          <div  className="w-full md:w-1/2 ml-[-20%] pl-20 mt-[-36%] flex ">
            <Image src="/chair2.png" alt="Chair" className="w-1/2 md:w-full relative px-16" />
          </div>
        </div>
    </section>
  );
