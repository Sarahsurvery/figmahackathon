...
export const CartProvider = ({ children }: any) => {
  ...
  const toggleCartItemQty = (id: any, value: any) => {
    ...
    //     if(value === 'plus'){
    //         updatedCartItems[index] ={...updatedCartItems[index],quantity:foundProduct.quantity + 1}
    //         setCartItems([...updatedCartItems]);

    //         // setCartItems([...otherProducts,{...foundProduct, quantity:foundProduct.quantity + 1}])
    //     setTotalPrice((prevTotalPrice)=> prevTotalPrice + foundProduct.price)
    //       setTotalQuantity((prevTotalQty) => prevTotalQty+1)
